...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '1907166812')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002117159265')
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'b3552dc21853668b56c3f3b30d73ccf067caeda1')
...
SPRT_CHNL = environ.get('SPRT_CHNL', 'https://t.me/hotflashdealss')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Movies_real_hd')
TUTORIAL = environ.get('TUTORIAL', '')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', False))
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', '')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002015830095'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'hotflashdealss')
